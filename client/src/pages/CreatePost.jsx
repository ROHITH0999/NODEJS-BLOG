...
const CreatePost = () => {
  ...
  const [category, setCategory] = useState('Uncategorized'); // Initialize to 'Uncategorized'
  ...
  const handleCreatePost = async (e) => { // Renamed to avoid conflict with the component name
    e.preventDefault();
  ...
  return (
    <section className="create-post">
      <div className="container">
        ...
        <form className="form create-post__form" onSubmit={handleCreatePost}>
